...
# Tabla para almacenar mensajes cifrados con Vigenère
class VigenereCifrado(models.Model):
...
# Tabla para almacenar mensajes descifrados con Vigenère
class VigenereDescifrado(models.Model):
    usuario = models.ForeignKey(User, on_delete=models.CASCADE)  # Usuario relacionado
    mensaje_cifrado = models.TextField()
    clave = models.CharField(max_length=255)
...
class MensajeCifrado(models.Model):
