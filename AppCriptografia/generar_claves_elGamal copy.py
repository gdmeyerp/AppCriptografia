...
KEYS_DIR = "AppCriptografia/AppCriptografia/keys/elgamal_keys_1024.json"

def generar_y_guardar_claves(bits=1024):
    ...
    print("Claves guardadas en elgamal_keys_1024.json")
